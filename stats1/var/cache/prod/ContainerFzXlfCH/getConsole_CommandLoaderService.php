...
return $this->services['console.command_loader'] = new \Symfony\Component\Console\CommandLoader\ContainerCommandLoader(new \Symfony\Component\DependencyInjection\Argument\ServiceLocator($this->getService, [
    ...
    'fm_elfinder.command.installer' => ['privates', 'fm_elfinder.command.installer', 'getFmElfinder_Command_InstallerService.php', true],
    'oneup_uploader.command.clear_chunks' => ['privates', 'oneup_uploader.command.clear_chunks', 'getOneupUploader_Command_ClearChunksService.php', true],
    'oneup_uploader.command.clear_orphans' => ['privates', 'oneup_uploader.command.clear_orphans', 'getOneupUploader_Command_ClearOrphansService.php', true],

...
// Returns the public 'mautic.channel.model.queue' shared service.
...
$this->services['mautic.channel.model.queue'] = $instance = new \Mautic\ChannelBundle\Model\MessageQueueModel(($this->services['mautic.lead.model.lead'] ?? $this->getMautic_Lead_Model_LeadService()), ($this->services['mautic.lead.model.company'] ?? $this->getMautic_Lead_Model_CompanyService()), $a);

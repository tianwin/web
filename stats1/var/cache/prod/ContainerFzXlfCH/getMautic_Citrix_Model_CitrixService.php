...
// Returns the public 'mautic.citrix.model.citrix' shared service.

$this->services['mautic.citrix.model.citrix'] = $instance = new \MauticPlugin\MauticCitrixBundle\Model\CitrixModel(($this->services['mautic.lead.model.lead'] ?? $this->getMautic_Lead_Model_LeadService()), ($this->services['mautic.campaign.model.event'] ?? $this->load('getMautic_Campaign_Model_EventService.php')));

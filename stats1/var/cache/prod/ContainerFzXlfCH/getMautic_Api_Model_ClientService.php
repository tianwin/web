...
// Returns the public 'mautic.api.model.client' shared service.

$this->services['mautic.api.model.client'] = $instance = new \Mautic\ApiBundle\Model\ClientModel(($this->services['request_stack'] ?? ($this->services['request_stack'] = new \Symfony\Component\HttpFoundation\RequestStack())));

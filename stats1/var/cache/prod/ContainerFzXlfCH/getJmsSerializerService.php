...
$a->setCache(($this->privates['jms_serializer.metadata.traceable_cache'] ?? $this->load('getJmsSerializer_Metadata_TraceableCacheService.php')));
...
$f = new \JMS\SerializerBundle\Debug\TraceableEventDispatcher(new \Symfony\Component\DependencyInjection\Argument\ServiceLocator($this->getService, [
    'jms_serializer.traceable_runs_listener' => ['privates', 'jms_serializer.traceable_runs_listener', 'getJmsSerializer_TraceableRunsListenerService.php', true],

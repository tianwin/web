...
// Returns the public 'mautic.channel.model.message' shared service.

$this->services['mautic.channel.model.message'] = $instance = new \Mautic\ChannelBundle\Model\MessageModel(($this->services['mautic.channel.helper.channel_list'] ?? $this->getMautic_Channel_Helper_ChannelListService()), ($this->services['mautic.campaign.model.campaign'] ?? $this->load('getMautic_Campaign_Model_CampaignService.php')));

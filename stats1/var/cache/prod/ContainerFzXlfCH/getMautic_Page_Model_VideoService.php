...
// Returns the public 'mautic.page.model.video' shared service.

$this->services['mautic.page.model.video'] = $instance = new \Mautic\PageBundle\Model\VideoModel(($this->services['mautic.helper.ip_lookup'] ?? $this->getMautic_Helper_IpLookupService()), ($this->services['mautic.tracker.contact'] ?? $this->getMautic_Tracker_ContactService()));

...
// Returns the public 'mautic.campaign.model.summary' shared service.

$this->services['mautic.campaign.model.summary'] = $instance = new \Mautic\CampaignBundle\Model\SummaryModel(($this->services['mautic.campaign.repository.lead_event_log'] ?? $this->load('getMautic_Campaign_Repository_LeadEventLogService.php')));

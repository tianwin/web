...
// Returns the public 'mautic.lead.model.device' shared service.

$this->services['mautic.lead.model.device'] = $instance = new \Mautic\LeadBundle\Model\DeviceModel(($this->services['mautic.lead.repository.lead_device'] ?? $this->getMautic_Lead_Repository_LeadDeviceService()));
